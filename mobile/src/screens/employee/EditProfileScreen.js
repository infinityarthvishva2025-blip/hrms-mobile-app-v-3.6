...
const PickerField = ({ label, value, options, onChange }) => {
    ...
    return (
        <View style={styles.fieldWrap}>
            ...
            <TouchableOpacity style={[styles.input, styles.pickerBtn]} onPress={() => setOpen(!open)}>
...
const FieldInput = ({ label, value, onChange, multiline = false, keyboardType = 'default', editable = true, secureTextEntry = false, autoCapitalize = 'characters' }) => (
    <View style={styles.fieldWrap}>
        <Text style={styles.fieldLabel}>{label}</Text>
        <TextInput
